...
checksum_revisions = [(rev.get('sha1',None),rev) for rev in all_revs if 'sha1' in rev]
...
all_deleted_tokens = list(map(find_reverted_tokens_list, list(reverts)[0:100]))
